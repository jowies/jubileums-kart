    ...
    return (
      <div style={{ padding: '10px 10px 10px 10px' }}>
        <div style={{ height: this.props.height - 90, maxWidth: 400, width: this.props.width - 20, maxHeight: this.props.height - 75 }} >
          <div style={{ height: '100%', width: '100%', backgroundColor: '#fafafa', boxShadow: '0 1px 5px rgba(0,0,0,0.4)' }}>
            <button className="menu" onClick={this.props.onClick} style={{ padding: '10px 10px 10px 10px', backgroundColor: '#fafafa', cursor: 'pointer' }}>
              <i style={{ fontSize: '24px' }} className="fa fa-times"></i>
            </button>
            <div style={{ height: '100%', width: '100%', color: '#212121', padding: '0 10px 10px 10px' }}>
              <h1 style={{ textAlign: 'center' }} >Glassjakten</h1>
              <p>Glassjakten er en konkurranse arrangert over hele Gløshaugen i regi Abakus sitt 40 års jubileum.</p>
              <p>Gjemt rundt på campus er en rekke ølglass. Finn glasset, skriv inn koden under, og vær med i trekningen av fete premier!</p>
